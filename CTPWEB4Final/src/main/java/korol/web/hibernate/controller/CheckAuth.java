...
public class CheckAuth {
	...
	{
		return "User page. You are: " + 
				principal.getUser().getPerson().getName() + 
				" " + principal.getUser().getPerson().getSurname();
	}
	
	@GetMapping("/admin")
	private String admin(@AuthenticationPrincipal AuthUserDetails principal)
	{
		return "Admin page. You are: " + principal.getUser().getPerson().getName() + 
				" " + principal.getUser().getPerson().getSurname();
	}
